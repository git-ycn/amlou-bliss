...
function SwipeSection({ onSwipeComplete, onQuickAdd, onShopNow, onProductClick }: any) {
  ...
  return (
    <section id="swipe-section" dir="ltr" className="relative w-full min-h-[85vh] bg-[#F5F5F1] py-20 overflow-hidden flex flex-col items-center justify-center border-t border-black/5 z-30">
