           ...
           <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20, opacity: 0, transition: { duration: 0.3 } }} className="bg-[#F5F5F1] w-full max-w-6xl h-[95vh] rounded-[2rem] overflow-hidden flex flex-col relative shadow-2xl" onClick={e => e.stopPropagation()}>
              ...
              <div className="flex flex-col md:flex-row h-full overflow-y-auto">
               ...
               <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 mb-8 leading-relaxed">{t(product.id + '_desc')}</p>
...
const SwipeCard = memo(({ card, index, isTop, onSwipe, exitDir }: any) => {
  ...
  return (
    ...
    >
      ...
      <div className="h-[70%] w-full relative bg-gray-200 pointer-events-none">
        <img src={card.img} alt={t(card.title_key)} className="w-full h-full object-cover pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/5 to-transparent pointer-events-none"></div>
      </div>
      
      <div className="h-[30%] w-full p-6 flex flex-col justify-center relative bg-[#EAE8E3] pointer-events-none">
        {isTop && (
          <div className="pointer-events-auto">
            <motion.button 
              ...
              onClick={handleX}
              className="absolute -top-8 left-6 w-16 h-16 bg-white rounded-full shadow-[0_8px_20px_rgba(0,0,0,0.12)] flex items-center justify-center text-red-500 hover:shadow-[0_8px_25px_rgba(239,68,68,0.3)] transition-shadow z-30"
            >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.9, rotate: 15 }}
              onClick={handleHeart}
              className="absolute -top-8 right-6 w-16 h-16 bg-white rounded-full shadow-[0_8px_20px_rgba(0,0,0,0.12)] flex items-center justify-center text-green-500 hover:shadow-[0_8px_25px_rgba(34,197,94,0.3)] transition-shadow z-30"
            >
